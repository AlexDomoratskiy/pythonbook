...
Загрузите файл[guessing\_game.py](http://anytask.s3.yandex.net/additional/1 year/1/files/guessing_game.py). Это тоже программа на Питоне. Для начала просто запустите её \(двойным кликом\). Как видите, это игра-угадайка. Шанс угадать невелик, у кого получится – тот везучий. Как бы облегчить выигрыш?
...
[**Необязательное задание «Взлом планетной угадайки — 2»**](https://lms.yandexlyceum.ru/task/view/667). «Взломайте»[guessing\_game\_2](http://anytask.s3.yandex.net/additional/1 year/1/files/guessing_game_2.py).

[**Необязательное задание «Взлом планетной угадайки — 3»**](https://lms.yandexlyceum.ru/task/view/668). «Взломайте»[guessing\_game\_3](http://anytask.s3.yandex.net/additional/1 year/1/files/guessing_game_3.py).
